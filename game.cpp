...
void Game::runGame() {
	...
	switch (rand() % 3) {
		case 0:
			t0 = *(new Tilemap("data/tilemaps/procgen/rExit/tmr0.txt", tiles, &bg2));
			break;
		case 1:
			t0 = *(new Tilemap("data/tilemaps/procgen/rExit/tmr1.txt", tiles, &bg2));
			break;
		case 2:
			t0 = *(new Tilemap("data/tilemaps/procgen/rExit/tmr2.txt", tiles, &bg2));
			break;
	}
	...
	switch (rand() % 3) {
	case 0:
		t1 = *(new Tilemap("data/tilemaps/procgen/lExit/tml0.txt", tiles, &bg1));
		break;
	case 1:
		t1 = *(new Tilemap("data/tilemaps/procgen/lExit/tml1.txt", tiles, &bg1));
		break;
	case 2:
		t1 = *(new Tilemap("data/tilemaps/procgen/lExit/tml2.txt", tiles, &bg1));
		break;
	}
	...
	while (running && gameState == 1) {
		...
		if (roomNum == 0) {
			...
			*/
			...
			//t1.drawTilemap(gRenderer, rem_bg);
		}
